## This project was originally obtained from a public GitHub repository and was used as a DevOps/Docker practice project.

## I removed the original containerization configuration and created the Docker setup from scratch.
